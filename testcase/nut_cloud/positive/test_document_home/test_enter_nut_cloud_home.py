...
class TestEnterNutCloudHome:
    ...
    # def test_click_return_button(self, enter_nut_cloud_home):
    #     enter_nut_cloud_home.set_skip_default_cleanup()
    #
    #     def enter_nut_cloud():
    #         with allure.step("网盘主页-进入网盘"):
    ...
    #         ("enter_folder_page_parametrized", "文件页面")  # 第二个场景：文件夹页面
    #     ]
    # )
    ...
    # def test_click_transmission_list(self, request: FixtureRequest, page_fixture, page_name):
    #     current_page = request.getfixturevalue(page_fixture)
    #
    #     if page_fixture == "enter_folder_page_parametrized":
    #         current_page.set_skip_default_cleanup()
    #
    #         def click_return():
    #             current_page.navigate_back(3)
    #
    #         current_page.register_cleanup(click_return)
    #     with allure.step("点击传输按钮"):
    #         result = current_page.click_transmission_button()
    #         assert result.verify_click_enter_transmission_list() == "传输列表", f"进入传输列表失败"
    #
    # @pytest.mark.parametrize(
    #     "page_fixture",
    #     [
    #         "enter_nut_cloud_home",  # 第一个场景：首页
    #         "enter_folder_page_parametrized"  # 第二个场景：文件夹页面
    #     ]
    # )
    # @allure.story("用户点击刷新按钮")
    # @allure.title("用户验证弹出刷新提示")
    # def test_click_refresh_button(self, page_fixture, request: FixtureRequest):
    #     current_page = request.getfixturevalue(page_fixture)
    #     if page_fixture == "enter_nut_cloud_home":
    #         current_page.set_skip_default_cleanup()
    #
    #     with allure.step("点击刷新"):
    #         current_page.click_refresh_button()
    #
    # @pytest.mark.parametrize(
    #     "page_fixture",
    #     [
    ...
    # def test_click_new_folder_button(self, page_fixture, more_pop_window_page, request: FixtureRequest):
    #     current_page = request.getfixturevalue(page_fixture)
    #     current_page.set_skip_default_cleanup()
    #     if page_fixture == "enter_folder_page_parametrized":
    #
    #         def return_home():
    #             current_page.navigate_back(4)
    #
    #         current_page.register_cleanup(return_home)
    #     elif page_fixture == "enter_nut_cloud_home":
    #
    #         def click_return():
    #             current_page.navigate_back(2)
    #
    #         current_page.register_cleanup(click_return)
    #     with allure.step("点击新建文件夹"):
    #         more_pop_window_page.click_specify_coordinates(new_folder_coordinates_data)
    #         assert current_page.get_new_file_text() == "新建文件夹", f"点击更多按钮失败"
    #
    # @pytest.mark.parametrize(
    #     "page_fixture",
    #     [
    ...
    # def test_switch_list_mode(self, more_pop_window_page, page_fixture, request: FixtureRequest):
    #     current_page = request.getfixturevalue(page_fixture)
    #
    #     if page_fixture == "enter_nut_cloud_home":
    #         current_page.set_skip_default_cleanup()
    ...
    #             more_pop_window_page.click_specify_coordinates(list_pattern_coordinates_data)
    #
    #         current_page.register_cleanup(switch_view_mode)
    #     if page_fixture == "enter_folder_page_parametrized":
    #         current_page.set_skip_default_cleanup()
    #
    #         def switch_view_mode_page():
    #             current_page.click_more_button()
    #             more_pop_window_page.click_specify_coordinates(list_pattern_coordinates_data)
    #             current_page.navigate_back(3)
    #
    #         current_page.register_cleanup(switch_view_mode_page)
    ...
    # def test_switch_view_mode(self, more_pop_window_page, page_fixture, request: FixtureRequest, click_list_pattern,
    #                           click_more_button):
    #     current_page = request.getfixturevalue(page_fixture)
    #     if page_fixture == "enter_nut_cloud_home":
    #         current_page.set_skip_default_cleanup()
    ...
    #         result = more_pop_window_page.click_specify_coordinates(list_pattern_coordinates_data)
    #         assert result.verify_switch_view_mode_success(), f"切换视图模式失败"
    #
    # @pytest.mark.parametrize(
    #     "page_fixture",
    #     [
    ...
    # def test_click_batch_management(self, more_pop_window_page, page_fixture, request: FixtureRequest):
    #     current_page = request.getfixturevalue(page_fixture)
    #     if page_fixture == "enter_nut_cloud_home":
    #         current_page.set_skip_default_cleanup()
    #
    ...
    #     elif page_fixture == "enter_folder_page_parametrized":
    #
    #         def cancel_batch_management():
    #             more_pop_window_page.click_batch_management_return()
    #
    #         more_pop_window_page.register_cleanup(cancel_batch_management)
    #
    ...
    # def test_click_sort(self, more_pop_window_page, page_fixture, request: FixtureRequest):
    #     current_page = request.getfixturevalue(page_fixture)
    #
    #     def click_return():
    #         current_page.navigate_back(1)
    #
    #     if page_fixture == "enter_nut_cloud_home":
    #         current_page.set_skip_default_cleanup()
    #         current_page.register_cleanup(click_return)
    ...
    # def test_click_account_Information(self, more_pop_window_page, request: FixtureRequest, page_fixture):
    #     current_page = request.getfixturevalue(page_fixture)
    #     current_page.set_skip_default_cleanup()
    #
    #     def enter_nut_cloud():
    #         more_pop_window_page.navigate_back(1)
    #         home_page = HomePage(current_page.driver)
    #         home_page.click_cloud()
    #
    #     current_page.register_cleanup(enter_nut_cloud)
    #
